...
#[cfg(feature = "impl-abi_stable")]
deref_impl!(<'a, T> Serialize for abi_stable::std_types::RCowVal<'a, T> where T: Serialize + abi_stable::traits::IntoOwned);
#[cfg(feature = "impl-abi_stable")]
deref_impl!(<'a> Serialize for abi_stable::std_types::RCowStr<'a>);
#[cfg(feature = "impl-abi_stable")]
deref_impl!(<'a, T> Serialize for abi_stable::std_types::RCowSlice<'a, T> where T: Serialize + abi_stable::traits::IntoOwned);
